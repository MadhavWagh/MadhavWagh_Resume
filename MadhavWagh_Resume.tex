...
\photo[80pt][0.5pt]{picture.JPG} % The first bracket is the picture height, the second is the thickness of the frame around the picture (0pt for no frame)
...
\newcolumntype{P}[1]{>{\centering\arraybackslash}p{#1}}
 \begin{tabular}{|P{3cm}|P{4.5cm}|P{3.5cm}|P{3cm}|P{3cm}|}
   ...
   \hline
    ...
    Sem 1 to 6 (EXTC) & Sardar Patel Institute Of Technology & Mumbai University & 2018 & 9.14/10  \\ \hline
